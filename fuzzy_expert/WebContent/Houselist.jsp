            ...
            <div class="col-lg-8 col-md-12">
                ...
                <div class="property-box-2" >
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-pad">
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    ...
                                    <div class="price-box"><span>${house.price}</span>w RMB</div>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-7 col-pad align-self-center">
                            <div class="detail">
                                <h3 class="title">
                                    <a href="properties-details.html">${house.name}</a>
                                </h3>
                                <h5 class="location">
                                    <a href="properties-details.html">
                                        <i class="flaticon-pin"></i> ${house.area}, ${house.location}
                                    </a>
                                </h5>
                                <ul class="facilities-list clearfix">
                                    <li>
                                        <i class="flaticon-bed"></i> ${house.layout}
                                    </li>
                                    <li>
                                        <i class="flaticon-bathroom"></i> ${house.status}
                                    </li>
                                    <li>
                                        <i class="flaticon-ui"></i> ${house.room_area} m*m
                                    </li>
                                    <li>
                                        <i class="flaticon-car"></i> ${house.year} built
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="pagination-box p-box-2 text-center">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item" >
                                <a class="page-link" href="HouseList?page=${paging.page-1 }"><i class="fa fa-angle-left"></i></a>
                            </li>
                         <c:choose>
                         <c:when test="${paging.page==0}"> 
                           <li class="page-item"><a class="page-link active" href="HouseList?page=0">1</a></li>
                           </c:when>
                           <c:otherwise>
                           <li class="page-item"><a class="page-link" href="HouseList?page=0">1</a></li>
                           </c:otherwise> 
                           </c:choose>
                           <c:choose>
                         <c:when test="${paging.page==1}"> 
                            <li class="page-item"><a class="page-link active" href="HouseList?page=1">2</a></li>
                            </c:when>
                           <c:otherwise>
                           <li class="page-item"><a class="page-link" href="HouseList?page=1">2</a></li>
                           </c:otherwise> 
                           </c:choose>
                           <c:choose>
                         <c:when test="${paging.page==2}"> 
                            <li class="page-item"><a class="page-link active" href="HouseList?page=2">3</a></li>
                            </c:when>
                           <c:otherwise>
                           <li class="page-item"><a class="page-link" href="HouseList?page=2">3</a></li>
                           </c:otherwise> 
                           </c:choose>
                            <c:choose>
                         <c:when test="${paging.page==3}"> 
                            <li class="page-item"><a class="page-link active" href="HouseList?page=3">4</a></li>
                            </c:when>
                           <c:otherwise>
                           <li class="page-item"><a class="page-link" href="HouseList?page=3">4</a></li>
                           </c:otherwise> 
                           </c:choose>
                           <c:choose>
                         <c:when test="${paging.page==4}"> 
                            <li class="page-item"><a class="page-link active" href="HouseList?page=4">5</a></li>
                            </c:when>
                           <c:otherwise>
                           <li class="page-item"><a class="page-link" href="HouseList?page=4">5</a></li>
                           </c:otherwise> 
                           </c:choose>
                            <li class="page-item" >
                                <a class="page-link" href="HouseList?page=${paging.page+1}"><i class="fa fa-angle-right"></i></a>
                            </li>
                        </ul>
                    </nav>
                </div>
